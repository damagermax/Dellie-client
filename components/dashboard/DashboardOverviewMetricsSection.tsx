...
export function DashboardOverviewMetricsSection({
  currencyCode,
  revenueToday,
  salesToday,
  totalProducts,
  totalCustomers,
}: DashboardOverviewMetricsSectionProps) {
  const metrics = [
    {
      title: "Revenue Today",
        ...
        {metrics.map((metric, index) => (
          <div
            ...
            className={cn(
              ...
              index < metrics.length - 1 && "sm:border-r sm:border-gray-200 sm:pr-4 xl:border-r-0 xl:pr-0",
              index > 0 && "sm:pl-4",
            )}
          >
