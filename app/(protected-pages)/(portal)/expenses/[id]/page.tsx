...
export default function ExpenseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data, isLoading, isError } = useGetTransactionQuery(id, { skip: !id, refetchOnMountOrArgChange: true });
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f8faff_0%,#eef2ff_45%,#f7f8fc_100%)]">
      <ExpenseFormModal open={expenseModalOpen} toggle={toggleExpenseModal} initialValues={expense} />
      ...
      <div className="flex min-h-screen flex-col bg-gray-50 lg:flex-row">
        <section className="min-w-0 flex-1 border-r border-gray-200 bg-white lg:w-[70%] lg:flex-none">
          <div className="border-b border-gray-200 bg-gradient-to-b from-white to-gray-50/70 px-4 pb-7 pt-5 md:px-8">
            <div className="flex flex-wrap items-start justify-between gap-5">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button type="text" className="!bg-gray-200/80 " icon={<Pencil size={15} />} />
              </div>
              {/* <div className="flex flex-wrap items-center gap-2">
          ...
          <PaymentView payments={expense.payments as Payment[]} />
        </section>
        ...
        <aside className="hidden w-full flex-col gap-4 bg-[#f7f8fd] px-4 pb-4 pt-5 lg:flex lg:w-[30%] lg:px-6 xl:sticky xl:top-0 xl:h-screen xl:overflow-y-auto">
          <div className="overflow-hidden bg-gray-100  ">
            ...
            <div className="p-4">
              <input ref={attachmentInputRef} type="file" accept="image/*" multiple className="hidden" onChange={handleAttachmentUpload} />
